                            ...
                            <div className="container">
                                ...
                                <div className="col-md-12">
                                    <div className="text-home">
                                        <h2 className="h2Informatorio"><strong>Lo mejor de estudiar</strong><br />
                                        un curso del futuro<br />
                                        es encontrar un<br />
                                            <strong>trabajo en el presente</strong></h2>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="subrayado"><img src={img7} alt="" /></div>
                                    </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="txt">
                                            <p>
                                                ...
                                                de  Software y Servicios Informáticos a través de la formación
                                                en  programación. Se trata de un espacio de aprendizaje
                                                práctico, con clases innovadoras y creativas, que persiguen
                                                la inclusión social, digital y laboral a través del empleo en
                                                empresas de la  industria del software, o iniciando sus
                                                propios emprendimientos de base tecnológica.
                                            </p>
                                            <p>
                                                Es un programa del Gobierno del Chaco, llevado adelante
                                                por la Subsecretaría de Empleo, dependiente del Ministerio
                                                de Producción, Industria y Empleo, trabajando en conjunto
                                                con las empresas del Polo IT Chaco, la UTN-FRRe y la
                                                UNCAUS.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="video">
                                            ...
                                            <div className="embed-responsive embed-responsive-16by9">
                                                <iframe src="https://www.youtube.com/embed/N0G7_fL79Yw" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="paso-2">
                                            ...
                                            <div className="paso-p">
                                                ...
                                                desarrollar aplicaciones web con bases de datos,
                                                y adquirir conocimientos que te permitan seguir
                                            ...
                                            <ul className="pas">
                                                ...
                                                <li className="requi">
                                                    Requisitos:<br />
                                                        - Haber aprobado curso de  Introducción a la Programación. <br />
                                                        - Residir en Chaco
                                                    </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="w-100"><hr className="visible-mobile" /></div>
                                    <div className="col-md-6">
                                        <div className="paso-1">
                                            <div className="paso-head">
                                            ...
                                            <div className="paso-p">
                                                Podrás continuar con tu perfeccionamiento en
                                                lenguajes especíﬁcos, y orientar tu fomación hacia
                                                los perﬁles laborales requeridos por las empresas
                                                locales.
                                                    </div>
                                            <div className="linea">
                                            ...
                                            <ul className="pas">
                                                ...
                                                <li className="dura">Duración: De 2 a 4 meses, (dependiendo de la temática)</li>
                                                <li className="requi">
                                                    Requisitos: <br />
                                                            - Haber aprobado curso Programación y Desarrollo Web. <br />
                                                            - Residir en Chaco.
                                                        </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="paso-2">
                                            ...
                                            <div className="paso-p">
                                                Adquirirás herramientas que te permitan iniciar
                                                un emprendimiento vinculado a las TICs, y
                                                podrás acceder a ﬁnanciamiento para su puesta
                                                en marcha al ﬁnalizar el ciclo.
                                                    </div>
                                            <div className="linea">
                            ...
                            <div className="container containerResutlados">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="subrayado"><img src={img17} alt="" /></div>
                                    </div>
                                    <div className="col-md-6"></div>
                                </div>
                                <div className="row">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="subrayado"><img src={img20} alt="" /></div>
                                    </div>
                                    <div className="col-md-6"></div>
                                    <div className="w-100"></div>
                                    <div className="col-12">
                                            ...
                                            <div className={classes.root}>
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel1a-header"
                                                    >
                                                        <Typography className={classes.heading}> ¿Los cursos tienen algún costo o arancel?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            Todos los cursos del Informatorio son y serán siempre gratuitos, porque es una política del Gobierno Provincial que busca formar a chaqueños y chaqueñas en programación, para potenciar la industria del software y servicios informáticos.
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel2a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Al ﬁnalizar el cursado obtengo algún certiﬁcado?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel3a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Qué requisitos se exigen para participar del Informatorio?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel4a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Se requieren conocimientos previos para participar?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel5a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Puedo inscribirme si estoy cursando una carrera universitaria o terciaria?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel6a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Los cursos del Informatorio me sirven para reparar computadoras?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel7a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Qué cursos tienen inscripción abierta?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            El recorrido que proponemos se inicia con el curso Introducción a la Programación, cuya inscripción estará abierta desde el 20/02/2021 hasta el 05/03/2021, y su cursado se realizará de manera online del 10/03/2021 al 10/04/2021.                                                    </Typography>
                                                    </AccordionDetails>
                                                </Accordion>
                                                {/* <div className="card">
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel8a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Qué necesito para hacer el curso de Introducción a la programación?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            Debés contar con un dispositivo con acceso a internet, ya que la capacitación es a través de una plataforma educativa online. </Typography>
                                                    </AccordionDetails>
                                                </Accordion>
                                                {/* <div className="card">
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel9a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Cómo me inscribo al curso Introducción a la programación?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            Debés completar el formulario online con todos los datos requeridos, luego iniciar sesión en la plataforma con los datos que recibirás por correo, y completar los ejercicios propuestos; al finalizarlos habrás terminado el proceso de inscripción. </Typography>
                                                    </AccordionDetails>
                                                </Accordion>
                                                {/* <div className="card">
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel10a-header"
                                                    >
                                                        <Typography className={classes.heading}> Ingresé mal los datos en el formulario, ¿cómo hago para cambiarlo?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            Comunicate con nosotros a través del <strong><a href="mailto:informatorio@chaco.gob.ar">correo</a>,</strong> con el asunto “SOLICITUD DE CAMBIO DE DATOS” y contanos cuáles son los datos que necesitas modificar. </Typography>
                                                    </AccordionDetails>
                                                </Accordion>
                                                {/* <div className="card">
                                                ...
                                                <Accordion>
                                                    <AccordionSummary
                                                        ...
                                                        id="panel12a-header"
                                                    >
                                                        <Typography className={classes.heading}>¿Cuánto tiempo tendré que dedicarle al curso de Introducción a la Programación?</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <Typography>
                                                            El curso de Introducción a la Programación tiene una duración de un mes, con una carga semanal de 12 hs que deberás dedicarle. Lógicamente el tiempo podrá ser menor o mayor dependiendo de si tenés o no conocimientos previos y de qué tan rápido le agarres la mano.</Typography>
                                                    </AccordionDetails>
                                                </Accordion>
                                            </div>
                                            {/* <div className="card">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col visible-mobile">
                                        <div className="redes d-flex justify-content-center">
                                            <span className="red"><a href=" https://www.instagram.com/empleochaco/" target="_blank" rel="noopener noreferrer"><img width="48" src={img21} alt="" /></a></span>
                                            <span className="red"><a href="https://web.facebook.com/empleochaco" target="_blank" rel="noopener noreferrer"><img width="24" src={img22} alt="" /></a></span>
                                        </div>
                                        <div className="logo-informatorio">
                                            <span><img className="log" src={img23} alt="" /></span>
                                        </div>
                                        <div className="los-cumpa">
                                            <h4>ACOMPAÑAN:</h4>
                                            <div className="d-flex justify-content-around">
                                                <span><img src={img24} alt="" /></span>
                                                <span><img width="100" src={img25} alt="" /></span>
                                                <span><img width="100" src={img26} alt="" /></span>
                                                <span><img width="100" src={img27} alt="" /></span>
                                            </div>
                                        </div>
                                        <div className="gobierno d-flex justify-content-between">
                                            <span><img width="150" src={img28} alt="" /></span>
                                            <span><img width="320" src={img29} alt="" /></span>
                                            <span><img width="150" src={img30} alt="" /></span>
                                        </div>
                                    </div>
                                    {/*<!-- Mobile -->*/}
                                    <div className="col visible-desktop">
                                        <div className="redes d-flex justify-content-center">
                                            <span className="red"><img width="24" src={img31} alt="" /></span>
                                            <span className="red"><img width="12" src={img32} alt="" /></span>
                                        </div>
                                        <div className="logo-informatorio">
                                            <span><img className="log" src={img33} alt="" /></span>
                                        </div>
                                        <div className="los-cumpa">
                                            <h4>ACOMPAÑAN:</h4>
                                            <div className="d-flex justify-content-around">
                                                <span><img width="70" src={img34} alt="" /></span>
                                                <span><img width="70" src={img35} alt="" /></span>
                                                <span><img width="70" src={img36} alt="" /></span>
                                                <span><img width="70" src={img37} alt="" /></span>
                                            </div>
                                        </div>
                                        <div className="gobierno d-flex flex-column">
                                            <span><img width="100" src={img38} alt="" /></span>
                                            <span><img width="200" src={img39} alt="" /></span>
                                            <span><img width="100" src={img40} alt="" /></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
