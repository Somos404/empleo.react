                                    ...
                                    <Container>
                                        <Row>
                                            <Col lg="5" md="7" className="align-self-center">
                                                <h2 className="title font-bold rowSecondParrafoBold">Formalización de emprendimientos</h2>
                                                <hr class="justify-content-center lineaCopada" />
                                                <p className="m-t-40 m-b-30 rowSecondParrafoLight">¿Querés inscribir tu emprendimiento ante los organismos correspondientes, y también aprender cómo efectivizar liquidaciones y pagos mensuales?</p>
                                                <p className="m-t-40 m-b-30 rowSecondParrafoLight">En dos semanas conocerás  herramientas, aplicativos, sugerencias y recomendaciones  para formalizar tu emprendimiento ante los organismos de recaudación impositiva, tanto Nacionales como provinciales.</p>
{/* 
                                                ...
                                                <div className="contenidoCursos">
                                                    <Row className="justify-content-center">
                                                        ...
                                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive cardEspecificacionesEscritorio">
                                                            ...
                                                            <div>
                                                                <h6 className="font-medium textoEspe textoEspeEscritorio">2 SEMANAS DE DURACIÓN</h6>
                                                            </div>
                                                        </CardBody>
                                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive cardEspecificacionesEscritorio">
                                                            ...
                                                            <div>
                                                                <h6 className="font-medium textoEspe textoEspeEscritorio">2 HORAS SEMANALES</h6>
                                                            </div>
                                                        </CardBody>
                                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive cardEspecificacionesEscritorio">
                        ...
                        <div className="ContenedorResponsiveCursosHidden">
                            <Container className="backgroundPrimerContenedor backgroundPrimerContenedorResponsiveCursosSecos">                     
                                <Col>
                                    <Row className="justify-content-center">
                                        <h1 className="text-center title titleCursosEscritorio">Formalización de emprendimientos</h1>
                                        {/**REsponsive */}
                                        <h1 className="text-center title titleCursosResponsive">Formalización de emprendimientos</h1>

                                    </Row>
                                    <hr class="justify-content-center lineaCopada" />
                                    <div className="separadorM"></div>
                                    <Row className="justify-content-left">
                                        <p className="text-left parrafoCursos">¿Querés inscribir tu emprendimiento ante los organismos correspondientes, y también aprender cómo efectivizar liquidaciones y pagos mensuales?
                                                </p>
                                                <p className="text-left parrafoCursos">En dos semanas conocerás  herramientas, aplicativos, sugerencias y recomendaciones  para formalizar tu emprendimiento ante los organismos de recaudación impositiva, tanto Nacionales como provinciales.
                                                </p>
                                    </Row>
                                ...
                                <Col>
                                    ...
                                    <Col md="8">
                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive">
                                            ...
                                            <div>
                                                <h6 className="font-medium textoEspe">2 SEMANAS DE DURACIÓN</h6>
                                            </div>
                                        </CardBody>
                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive2">
                                            ...
                                            <div>
                                                <h6 className="font-medium textoEspe">2 HORAS SEMANALES</h6>
                                            </div>
                                        </CardBody>
                                        <CardBody className="d-flex no-block cardEspecificacionesResponsive2">
