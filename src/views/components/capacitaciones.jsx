              ...
              <Row xs="2">
                <Col lg="6" className="">
                  <section className="text-gray-600 body-font">
                    <div
                      className={`${classes.contenedor1} container px-5 py-24 mx-auto cont1Izq`}
                    >
                      <Row className="justify-content-center">
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 titulo1ContCap">
                          Te brindamos cursos para tu formación <br /> laboral y
                          emprendedora
                        </h1>
                      </Row>
                      <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto contLeft">
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 titulo1ContResponsive">
                          Te brindamos cursos para tu formación laboral y
                          emprendedora
                        </h1>
                      </div>
                      ...
                      <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto contLeft ContLeftP">
                        <p className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 parrafo1Cont">
                          Ponemos a disposición de la población chaqueña una
                          plataforma online de capacitaciones con cursos cortos,
                          dinámicos y entretenidos para que puedas desarrollar
                          tus capacidades, mejorar tus posibilidades para
                          conseguir empleo, e iniciar o fortalecer tu
                          emprendimiento.
                        </p>
                      </div>
                      <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto contLeft ContLeftP">
                        <p className="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900 parrafo1Cont">
                          Buscamos que cada persona de la comunidad chaqueña
                ...
                <Row md="8" lg="12" className="colRequerimientosCap">
                  <Row className="imagenInfo">
                    <img
                      src={img7}
                      alt="img"
                      className="img-responsive img-thumbnail imgResponsiveInformat"
                      width="200"
                    />
                  </Row>
                ...
                <CardGroup>
                  <Card className="cardsecondContRed">
                    ...
                    <CardBody className="cardBodyRed">
                      ...
                      <CardText className="card-sub-title-red">
                        ...
                        chaqueñas y chaqueños para el desarrollo laboral de la
                        población.
                      </CardText>
                    </CardBody>
                  </Card>
                  <Card className="cardsecondContRed2">
                    ...
                    <CardBody className="cardBodyRed">
                      ...
                      <hr className="lineaCard" />
                      <CardText className="card-sub-title-red">
                        Por cada curso que finalices obtendrás un certificado
                        validado por el Ministerio de Producción, Industria y
                        Empleo de la provincia del Chaco. Cada certificación es
                        personalizada, con un identificador único que sirve para
                ...
                <CardGroup>
                  <Card className="cardsecondContRed">
                    ...
                    <CardBody className="cardBodyRed">
                      ...
                      <CardText className="card-sub-title-red">
                        ...
                        acompañará facilitando el proceso de aprendizaje,
                        guiándote en el recorrido, y aclarando todas las dudas
                        que tengas.
                      </CardText>
                    </CardBody>
                  </Card>
                  <Card className="cardsecondContRed2">
                    ...
                    <CardBody className="cardBodyRed">
                      ...
                      <hr className="lineaCard" />
                      <CardText className="card-sub-title-red">
                        Podrás realizarlo manejando tus propios tiempos, pero
                        siempre tendrás objetivos semanales que cumplir.
                      </CardText>
                    </CardBody>
                  </Card>
                </CardGroup>
