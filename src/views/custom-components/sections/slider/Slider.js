  ...
  return (
    <>
      <div className={classes.preslider}>
        <h1 className={classes.titleins}>Inscripciones abiertas</h1>
      </div>
      <Slider {...proppsslider}>
        {props.content.map((item, index) => (
          <div
            ...
            style={{
              background: `url(https://empleo.chaco.gob.ar/slider/${item.imgSliderUrl}.png)`,
              ...
              <Col className={classes.colContanerTitulo}>
                <h1 className={classes.title}>
                  <Link
                    ...
                    to={{
                      pathname: `/capacitaciones/${item.nombre
