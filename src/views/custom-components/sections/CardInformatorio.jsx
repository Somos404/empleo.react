...
const CardInformatorio = (props) => {
  ...
  return (
    <div>
      {curso && desk && (
        <Card
          className={`${classes.capacitacionesInfoCardMU} capacitacionesInfoCard`}
        >
          <span className="img-ho contenedorImgCap">
            <img
              className="img-responsive img-thumbnail img-redirecciones img-InfoCap "
              src={iconoCard[props.pos]}
              alt="wrappixel kit"
            />
          </span>
          <div
            className={`${classes.imgAmarillaInfoCapTarjeta} date-pos bg-info-gradiant imgAmarillaInfoCap`}
          >
            <span className="numeroCardInfoCap">0{props.pos + 1}</span>
          </div>
          <h5 className="font-medium m-t-30 tituloCardInfoCap">
            <Link
              to={`/capacitaciones/${curso.nombre
          ...
          <span className=" contenedorImgLineaCap contenedorImgLineaCap1">
            <img
              className="img-responsive img-thumbnail img-redirecciones imgLinea-InfoCap imgLinea-InfoCap1 img-responsiveInfoCapLinea"
              src={lineaCard[props.pos]}
              alt="wrappixel kit"
            />
          </span>

          <p className="m-t-20 paraffoInfoCap">{curso.descrip_card}</p>
          <Row className={`${classes.botonRowInfoMU} justify-content-center`}>
            <Link
              to={`/capacitaciones/${curso.nombre
                .replace(/([a-z])([A-Z])/g, "$1-$2")
                .replace(/\s+/g, "-")
      ...
      {curso && mobile && (
        <Card className="capacitacionesInfoCard capacitacionesInfoCardResponsive">
          <Container ClassName="containerCardInforResponsive">
            <Row className="rowCardInforResponsive">
              <Col>
                <span className=" contenedorImgLineaCap contenedorImgLineaCap1">
                  <img
                    className="img-responsive img-thumbnail img-redirecciones imgLinea-InfoCap imgLinea-InfoCap1 img-responsiveInfoCapLinea img-redireccionesInfoCapResp"
                    src={lineaCard[props.pos]}
                    alt="wrappixel kit"
                  />
                </span>
              ...
              <Col>
                <span className="img-ho contenedorImgCap contenedorImgCapInfResponsive">
                  <img
                    className="img-responsive img-thumbnail img-redirecciones img-InfoCap "
                    src={iconoCard[props.pos]}
                    alt="wrappixel kit"
          ...
          <div className="date-pos bg-info-gradiant imgAmarillaInfoCap">
            <span className="numeroCardInfoCap">0{props.pos + 1}</span>
          </div>
          <h5 className="font-medium m-t-30 tituloCardInfoCap tituloCardInfoCapResponsive">
            <a href="#" className="link">
              {curso.nombre}
            </a>
          </h5>
          <p className="m-t-20 paraffoInfoCap paraffoInfoCapResponsive">
            {curso.descrip_card}
          </p>
