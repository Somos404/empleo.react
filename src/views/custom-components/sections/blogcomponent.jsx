        ...
        <Container>
          <Row className="justify-content-center">
            <Row className=" justify-content-center imagenInfo">
              <div className="titulosInfoCapHab justify-content-left">
                <h1 className="title-1 titleInfoCaHab titleInfoCaHabHeight">
                  Animate a trabajar
                </h1>
                <h1 className="title-1 titleInfoCaHab">
                  en el mundo del{" "}
                  <span className="textTituloboldInfoCap">software</span>{" "}
                </h1>
                <h1 className="title-1 titleInfoCaHabBold TitHeaderCapbold">
                  y programación
                </h1>
            ...
            <Row className="justify-content-center">
              <img
                src={imgInfo}
                alt="img"
                className="img-responsive img-thumbnail imgResponsiveInformatMun imgResponsiveInformatCap imgResponsiveInformatCapMArginLeft "
              />
            </Row>

            <Row className="rowSubtInfoCap">
              <Col md="6" className="text-left marginDescInfo">
                <p className="m-t-20 parrafoCursos">
                  Para que tengas más y mejores oportunidades de incorporarte a
                  la Economía del Conocimiento, especíﬁcamente en el sector del
                  Software a través de la formación en programación.
                </p>
              </Col>
              <Col md="6" className="text-left marginDescInfo">
                <p className="m-t-20 parrafoCursos">
                  Es un programa del Gobierno del Chaco en conjunto con las
                  empresas del Polo IT Chaco, Globant, UTN y UNCAUS.
                </p>
              </Col>
            </Row>
          </Row>
          ...
          <Row className="m-t-40 justify-content-center">
            {props.cardCursosInfo.Cursos.map((cursoCard, i) => (
              <Col lg="3" md="4">
                <CardInformatorio pos={i} curso={cursoCard} />
              </Col>
            ))}
          </Row>
        </Container>
        ...
        <Container>
          <Row className="justify-content-left">
            <Col md="6" className="align-self-left text-left">
              <a
                ...
                href="https://capacitaciones.chaco.gob.ar/mod/page/view.php?id=697"
              >
                <span>
                  PREGUNTAS FRECUENTES <i className="ti-arrow-right"></i>
                </span>
              </a>
              <a
                className="btn btn-outline-light btn-rounded btn-md btn-arrow m-t-20 btonContactoInfoCap btonContactoInfoCapResponsive"
                data-toggle="collapse"
                href="https://docs.google.com/forms/d/e/1FAIpQLSePDRc-9AWh5h59F5WY3cY52v9AtcphAokKId_Nw93ZsRkyBA/viewform"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span>
                  QUIERO OTRAS CAPACITACIONES <i className="ti-arrow-right"></i>
                </span>
              </a>
              <a
                className="btn btn-outline-light btn-rounded btn-md btn-arrow m-t-20 btonContactoInfoCap btonContactoInfoCapResponsive"
              ...
              >
                <span>
                  CONTACTO <i className="ti-arrow-right"></i>
                </span>
              </a>
            </Col>
          </Row>
          <Row className="justify-content-left">
            <Col
              lg="6"
              md="6"
              className="contenedor-social-footerInfCap align-self-center text-center"
            >
              <div className="round-social light">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <i className="fa fa-linkedin facefooter"></i>
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <i className="fa fa-twitter facefooter"></i>
                </a>
              </div>
            </Col>
          </Row>
